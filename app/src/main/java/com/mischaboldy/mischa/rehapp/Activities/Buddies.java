...
public class Buddies extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        appTitle.setText(R.string.buddy_title);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.help_button){
            InfoBoxHelper.openBox(this, "Buddies");
        }
        return super.onOptionsItemSelected(item);
    }

    public void viewBuddies(View view) {
        Intent intent = new Intent (this, ViewBuddies.class);
